    ...
    public function run(): void
    {
        ...
        BlogPost::query()->updateOrCreate(
            ...
            [
                ...
                'body' => '<p>FinVay hỗ trợ bạn hoàn tất luồng đăng ký vay: từ OTP, biểu mẫu, tài liệu đến kết quả và hợp đồng điện tử.</p><p>Nội dung này có thể chỉnh sửa trong trang quản trị mục <strong>Tin tức</strong>.</p>',
                'is_published' => true,
